function Location() {
  return (
    <section className="location">
      ...
      <p>
        Your safety matters to us! Get to know your way around the conference
        venue using this custom map we&apos;ve designed for you that helps you
        navigate the surroundings so you can easily move around
      </p>
      <iframe
